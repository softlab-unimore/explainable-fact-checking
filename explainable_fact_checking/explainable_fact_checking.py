...
from explanation_presentation import style_exp_list
...
class AddInputTxtToUse:
    @staticmethod
    def predict_and_save(feverous_model, input_file, output_file):
        with open(input_file, 'r') as f_in, open(output_file, 'w') as f_out:
            record_list = [json.loads(line) for line in f_in]
            predictions = feverous_model.predict(record_list)
            full_predictions = feverous_model.predictions
