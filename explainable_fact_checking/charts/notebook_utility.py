...
def end_fig_func(fig):
    ...
    fig.for_each_annotation(lambda a: a.update(text=xfc.charts.style.replace_words(a.text)))
    fig.for_each_trace(lambda t: t.update(name=xfc.charts.style.replace_words(t.name),
                                          legendgroup=xfc.charts.style.replace_words(t.name),
                                          hovertemplate=xfc.charts.style.replace_words(t.hovertemplate),
                                          )
                       )
    ...
    # fig.for_each_trace(lambda t: t.update(hovertemplate=xfc.charts.style.replace_words(t.hovertemplate)))
